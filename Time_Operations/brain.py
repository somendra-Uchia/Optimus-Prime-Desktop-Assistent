...
def parse_input(input_text):
    ...
    # Regular expression to extract time in format like "07:30 PM" or "03:30 am"
    ...
    if times:
        ...
        # Normalize the time formate to "hh:mmAM/PM"
        ...
        # Combined formatted time with command
...
def input_manage(input_text):
    ...
    if output != "No valid time found in input":
        save_to_file(output, time,r'C:\Users\Somendra\OneDrive\Desktop\OPTIMUS-PRIME\schedule.txt')
        print("Scheduled_Data_Saved")
    else:
        print(output)    
...
def input_manage_Alam(input_text):
    ...
    if time != "No valid time found in input":  #
        save_to_Alarmfile(time,r'C:\Users\Somendra\OneDrive\Desktop\OPTIMUS-PRIME\Alam_data.txt')
        print("Scheduled_Data_Saved")
    else:
        print("pass")
